                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="/home/cart" class="single-icon"><i class="ti-bag"></i> <span class="total-count">${quantityCart}</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table shopping-summery">
                    ...
                    <tr>
                        ...
                        <td class="product-des" >
                            <p class="product-name">${cart.items.item}</p>
                        </td>
                        <td class="product-des" >
                            <p class="product-name">${cart.items.type}</p>
                        </td>
                        <td class="product-des" >
                            <p class="product-name">${cart.items.planet}</p>
                        </td>
                        <td class="product-des" >
                        ...
                        <td class="total-amount" ><span style="color: red;"><fmt:formatNumber value="${cart.items.price * cart.quantity}" pattern="#,###"/> VND</span></td>
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                <ul>
                                    ...
                                    <li class="last">Tổng tiền<span style="color: red"><fmt:formatNumber value="${total}" pattern="#,###"/> VND</span></li>
                                </ul>
                                <div class="button5">
